        ...
        <ul class="sidebar-content">
          ...
          <li>
            ...
            <ul class="sidebar-submenu">
              ...
              <li>
                <a href="./skeleton.html" class="sidebar-submenu-item"> Skeleton </a>
              </li>
              <li>
                      ...
                      <div class="flex flex-wrap items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                          <label for="top-selling-product-today" class="cursor-pointer">
                            ...
                            />
                            <span
                              class="text-xs text-slate-600 peer-checked:font-medium peer-checked:text-primary-500 dark:text-slate-400"
                              >Today</span
                            >
                          </label>
                  ...
                  <div class="card-body flex h-full flex-col">
                    ...
                    <div class="mt-auto divide-y dark:divide-slate-600">
                      ...
                      <div class="flex items-center gap-4 py-2">
                        <div
                          class="min-w-12 flex h-12 w-12 items-center justify-center rounded-sm bg-primary-500 bg-opacity-20 text-primary-500"
                        >
                        ...
                        <span class="ml-auto flex items-center text-sm font-medium text-success-500"
                      ...
                      <div class="flex items-center gap-4 py-2">
                        <div
                          class="min-w-14 flex h-12 w-12 items-center justify-center rounded-sm bg-success-500 bg-opacity-20 text-success-500"
                        >
                      ...
                      <div class="flex items-center gap-4 py-2">
                        <div
                          class="min-w-12 flex h-12 w-12 items-center justify-center rounded-sm bg-info-500 bg-opacity-20 text-info-500"
                        >
                        ...
                        <span class="ml-auto flex items-center text-sm font-medium text-danger-500"
                      ...
                      <div class="flex items-center gap-4 py-2">
                        <div
                          class="min-w-12 flex h-12 w-12 items-center justify-center rounded-sm bg-warning-500 bg-opacity-10 text-warning-500"
                        >
                ...
                <div class="card">
                  <div class="card-body flex h-full flex-col">
                    ...
                    <div class="mt-auto divide-y dark:divide-slate-600">
                      ...
                      <div class="flex items-center gap-4 py-2">
                        <div
                          class="min-w-12 flex h-12 w-12 items-center justify-center rounded-sm bg-success-500 bg-opacity-20 text-success-500"
                        >
                      ...
                      <div class="flex items-center gap-4 py-2">
                        <div
                          class="min-w-12 flex h-12 w-12 items-center justify-center rounded-sm bg-warning-500 bg-opacity-20 text-warning-500"
                        >
                          <i class="ti ti-social text-3xl"></i>
                        </div>
                      ...
                      <div class="flex items-center gap-4 py-2">
                        <div
                          class="flex h-12 w-14 items-center justify-center rounded-sm bg-info-500 bg-opacity-20 text-info-500"
                        >
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="mt-4 flex w-full gap-[6px]">
                      <div class="h-2 w-[40%] rounded-sm bg-primary-500"></div>
                      <div class="h-2 w-[20%] rounded-sm bg-success-500"></div>
                      <div class="h-2 w-[18%] rounded-sm bg-info-500"></div>
                      <div class="h-2 w-[12%] rounded-sm bg-warning-500"></div>
                      <div class="h-2 w-[10%] rounded-sm bg-danger-500"></div>
                    </div>
                    <br />
