        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="overflow-x-auto">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" class="checkbox variant-checkbox" value="{{ $variant->id }}">
                                </td>
                                <td>
                                    <div class="flex items-center gap-3">
                                        @if($variant->image)
                                            <img src="{{ asset($variant->image) }}" alt="{{ $variant->name }}" class="w-10 h-10 object-cover rounded-lg" />
                                        @else
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500 dark:text-slate-400">{{ $variant->display_name }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="text-xs">
                                        @if($variant->color)
                                            <span class="inline-block bg-blue-100 text-blue-800 px-2 py-1 rounded text-xs">{{ $variant->color->name }}</span>
                                        @endif
                                        @if($variant->size)
                                            <span class="inline-block bg-green-100 text-green-800 px-2 py-1 rounded text-xs ml-1">{{ $variant->size->name }}</span>
                                        @endif
                                    </div>
                                </td>
                                <td>
                                    <div class="text-sm">
                                        @if($variant->sale_price)
                                            <span class="text-primary-500 font-medium">${{ number_format($variant->sale_price, 2) }}</span>
                                ...
                                <td>
                                    <span class="text-sm {{ $variant->stock_quantity > 0 ? 'text-green-600' : 'text-red-600' }}">
                                ...
                                <td>
                                    <div class="flex gap-1">
                                        <a href="{{ route('admin.product-variants.show', $variant) }}" class="btn btn-sm btn-outline-info">
                                            <i data-feather="eye" class="w-3 h-3"></i>
                                        </a>
                                        <a href="{{ route('admin.product-variants.edit', $variant) }}" class="btn btn-sm btn-outline-primary">
                ...
                <div class="text-center py-8">
                    ...
                    <p class="text-xs text-slate-400 dark:text-slate-500">Try adjusting your filters or add a new variant.</p>
