<x-admin-layout>
    ...
    <div class="space-y-6">
            ...
            <div class="card-body">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <h6 class="text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Attributes</h6>
                            <div class="flex gap-2">
                                @if($variant->color)
                            ...
                            <div class="space-y-2 text-sm">
                                @if($variant->sale_price)
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="line-through text-slate-400">${{ number_format($variant->price, 2) }}</span>
                                    </div>
                                @else
                                    <div class="flex justify-between">
        ...
        <div class="flex flex-col justify-end gap-3 sm:flex-row">
            ...
            <a href="{{ route('admin.products.show', $variant->product) }}" class="btn btn-info">
