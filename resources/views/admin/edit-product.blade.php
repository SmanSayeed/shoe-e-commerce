                  ...
                  <form class="space-y-6" action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-4">
                      <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('admin.products.variants', $product) }}" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="flex">
                          ...
                          <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                              <p>This product uses variant-based stock management. Stock quantities are managed per color and size combination through product variants.</p>
                              <p class="mt-1">Manage variants and their stock through <strong>Product Details > Manage Variants</strong> ({{ $product->variants->count() }} variants currently).</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                          ...
                          <select id="product_track_inventory" name="track_inventory" class="select @error('track_inventory') is-invalid @enderror">
                        ...
                        <div class="space-y-2">
                          ...
                          <input
                            type="number"
                            id="product_min_stock_level"
                            name="min_stock_level"
                            class="input @error('min_stock_level') is-invalid @enderror"
                            placeholder="0"
                            min="0"
                    ...
                    <div class="space-y-4">
                      ...
                      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                          ...
                          <input
                            ...
                            name="dimensions"
                            class="input @error('dimensions') is-invalid @enderror"
                        ...
                        <div class="space-y-2">
                          ...
                          <input
                            ...
                            id="product_material"
                            name="material"
                            class="input @error('material') is-invalid @enderror"
                      ...
                      <div class="space-y-2">
                        ...
                        <textarea
                          ...
                          name="size_guide"
                          class="textarea @error('size_guide') is-invalid @enderror"
                          rows="3"
                          placeholder="Enter size guide information"
                        >{{ old('size_guide', $product->size_guide) }}</textarea>
                        @error('size_guide')
                          <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
                    ...
                    <div class="space-y-4">
                      ...
                      <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        ...
                        <div class="space-y-2">
                          ...
                          <select id="product_is_digital" name="is_digital" class="select @error('is_digital') is-invalid @enderror">
                            <option value="1" {{ ($product->is_digital ? 'selected' : '') }}>Yes</option>
                            <option value="0" {{ (!$product->is_digital ? 'selected' : '') }}>No</option>
                          </select>
                          @error('is_digital')
                            <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
