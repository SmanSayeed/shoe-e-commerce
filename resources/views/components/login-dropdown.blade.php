...
<div class="relative group">
  ...
  @else
    ...
    <a href="{{ route('login') }}" class="flex items-center text-slate-700 hover:text-slate-900 text-base sm:text-lg font-medium px-3 py-2 rounded-lg hover:bg-slate-100 transition-all duration-200">
