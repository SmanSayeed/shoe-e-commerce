...
<head>
    ...
    <title>Checkout - SSB Leather</title>
    ...
    <style>
        ...
        .progress-indicator {
            background: linear-gradient(90deg, #6366f1 33%, #e2e8f0 33%);
        }
    </style>
</head>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <span class="ml-3 text-sm font-medium text-gray-900">Information</span>
                </div>
                <div class="flex-1 mx-4">
                    <div class="h-0.5 bg-gray-200 rounded">
                        <div class="h-0.5 bg-indigo-600 rounded w-1/3"></div>
                    </div>
                </div>
                <div class="flex items-center">
                    ...
                    <span class="ml-3 text-sm font-medium text-gray-500">Shipping</span>
                </div>
                <div class="flex-1 mx-4">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <section class="form-section p-6">
                        <div class="flex items-center mb-6">
                            <div class="flex items-center justify-center w-8 h-8 bg-indigo-600 text-white rounded-full text-sm font-medium mr-3">
                                1
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="input-group">
                                <input type="text" id="first_name" name="first_name" placeholder=" " 
                                       class="w-full px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" required>
                    ...
                    <section class="form-section p-6">
                        <div class="flex items-center mb-6">
                            <div class="flex items-center justify-center w-8 h-8 bg-gray-300 text-gray-600 rounded-full text-sm font-medium mr-3">
                                2
                            </div>
                        ...
                        <div class="mb-6">
                            <label class="flex items-center space-x-3 cursor-pointer">
                                <input type="checkbox" id="same_as_billing" name="same_as_billing" 
                                       class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded focus:ring-indigo-500 focus:ring-2" checked>
                        ...
                        <div id="shipping_form" class="hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="input-group">
                                    <input type="text" id="shipping_first_name" name="shipping_first_name" placeholder=" " 
                                           class="w-full px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="space-y-3">
                                <label class="payment-option flex items-center justify-between p-4 rounded-lg cursor-pointer">
                                    <div class="flex items-center">
                                        <input type="radio" name="shipping_method" value="inside_dhaka" 
                                               class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 focus:ring-indigo-500 focus:ring-2" checked>
                                        <div class="ml-3">
