...
(function() {
    ...
    function renderNotifications(notifications) {
        ...
        container.innerHTML = notifications.map(notification => `
            <li class="flex gap-4 px-4 py-3 transition-colors duration-150 hover:bg-slate-100/70 dark:hover:bg-slate-700 ${!notification.is_read ? 'bg-blue-50/50 dark:bg-blue-900/10' : 'bg-slate-50/50 dark:bg-slate-800/30'}" 
                ...
                <div class="flex-1 min-w-0 cursor-pointer" onclick="window.location.href='${notification.order_id ? '/admin/orders/' + notification.order_id : '#'}'">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <button class="mark-read-btn-dropdown text-primary-500 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300" 
                ...
                ` : `
                <div class="flex-shrink-0 flex items-center">
                    <i data-feather="check-circle" class="w-5 h-5 text-green-500" title="Read"></i>
                </div>
                `}
            </li>
        `).join('');
    ...
    function addNotificationToDropdown(notification) {
        ...
        notificationEl.className = 'flex gap-4 px-4 py-3 transition-colors duration-150 hover:bg-slate-100/70 dark:hover:bg-slate-700 bg-blue-50/50 dark:bg-blue-900/10';
    ...
    // Show SweetAlert for new notification
    function showSweetAlert(notification) {
        if (typeof Swal !== 'undefined') {
            ...
            Swal.fire({
                ...
                confirmButtonText: notification.order_id ? 'View Order' : 'OK',
                ...
                if (result.isConfirmed && notification.order_id) {
    ...
    // Mark single notification as read (exposed globally)
